<template>
    <div>
        <div v-if="duration&&showDuration" class="x-audio-wrap" :class="{inline:!block}" ref="wrap" @click="play">
            <div class="x-sector" :class="{play:animate}">
                <div class="x-dot"></div>
            </div>
            <div class="x-time">{{time}}<span>"</span></div>
        </div>
        <div v-else="" class="x-audio-wrap" :class="{inline:!block}" ref="wrap">
            <div class="x-sector" :class="{play:animate}">
                <div class="x-dot"></div>
            </div>
